<?php
	...
	if ( ! isset($_SESSION['formMessage'])) {
		$_SESSION['formMessage'] = 'Te&scaron;&iacute; n&aacute;s V&aacute;&scaron; z&aacute;jem o na&scaron;e kurzy. Pros&iacute;me V&aacute;s o vyplněn&iacute; nez&aacute;vazn&eacute; objedn&aacute;vky kurzu.';	
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="desciption" content="Kontaktujte n&aacute;s. Nena&scaron;li jste na na&scaron;ich webov&yacute;ch str&aacute;nk&aacute;ch odpověď na ot&aacute;zku t&yacute;kaj&iacute;c&iacute; s produktů či služeb? Chcete, aby V&aacute;s kontaktoval někter&yacute; z na&scaron;ich pracovn&iacute;ků?" />
		<meta name="generator" content="RapidWeaver" />
		
		<title>OPEN AGENCY | Formul&aacute;ř podniky</title>
...
<form action="./files/mailer.php" method="post" enctype="multipart/form-data">
	 <div>
		...
		<label>M&aacute;m z&aacute;jem o kurz:</label> *<br />
		...
		<label>Počet &uacute;častn&iacute;ků v kurzu:</label> *<br />
		<select name="form[element4]">			<option <?php echo check('element4', 'select','1 &uacute;častn&iacute;k'); ?> value="1 &uacute;častn&iacute;k">1 &uacute;častn&iacute;k</option>
			<option <?php echo check('element4', 'select','2 &uacute;častn&iacute;ci'); ?> value="2 &uacute;častn&iacute;ci">2 &uacute;častn&iacute;ci</option>
			<option <?php echo check('element4', 'select','3 &uacute;častn&iacute;ci'); ?> value="3 &uacute;častn&iacute;ci">3 &uacute;častn&iacute;ci</option>
			<option <?php echo check('element4', 'select','4 &uacute;častn&iacute;ci'); ?> value="4 &uacute;častn&iacute;ci">4 &uacute;častn&iacute;ci</option>
			<option <?php echo check('element4', 'select','5 &uacute;častn&iacute;ků'); ?> value="5 &uacute;častn&iacute;ků">5 &uacute;častn&iacute;ků</option>
			<option <?php echo check('element4', 'select','6 &uacute;častn&iacute;ků'); ?> value="6 &uacute;častn&iacute;ků">6 &uacute;častn&iacute;ků</option>
			<option <?php echo check('element4', 'select','v&iacute;ce než 6 &uacute;častn&iacute;ků'); ?> value="v&iacute;ce než 6 &uacute;častn&iacute;ků">v&iacute;ce než 6 &uacute;častn&iacute;ků</option>
		</select><br /><br />
